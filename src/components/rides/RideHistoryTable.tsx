...
export function RideHistoryTable({
  ...
  console.log('Rendering ride history table with rides:', rides);
      ...
      <TableBody>
        {rides && rides.length > 0 ? (
          rides.map((ride) => {
            ...
            console.log('Rendering ride in table:', ride.id, ride.status);
                ...
                <TableCell>
                  <div className="flex items-center gap-2">
                    ...
                    {ride.status === 'completed' && !hasRating && (
                      <Dialog open={isRatingOpen && selectedRide === ride.id} onOpenChange={setIsRatingOpen}>
